...
with tab2:
    ...
    with col1:
        ...
        try:
            ...
            cursor.execute(
                "SELECT Company_name, Card_holder, Designation, Mobile_number, Email,"
                "Website, Area, City, State, Pin_code FROM bizcardx_data WHERE card_holder=%s",
                (cardholder_name,))
            ...
            if session_state.data_update:
                ...
                cursor.execute(
                    ...
                    "WHERE Card_holder=%s",
                    (
                        Company_name, Designation, Mobile_number, Email, Website, Area, City, State, Pin_code,
                        Card_holder))
